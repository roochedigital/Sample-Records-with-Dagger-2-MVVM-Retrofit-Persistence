package com.dearwolves.samplerecords.adapters
...
internal constructor(context: Context, private var mData: ListResponse<MediaResponse>) :
    ...
    fun setData(data: ListResponse<MediaResponse>) {
        mData = data
        notifyDataSetChanged()

    }

    fun getItem(position: Int): MediaResponse {
